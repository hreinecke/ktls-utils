...
/* ktls.c */
extern int tlshd_update_traffic_keys(unsigned char cipher,
				     gnutls_datum_t *ap_key,
				     gnutls_datum_t *ktls_key,
				     gnutls_datum_t *ktls_iv);
extern bool tlshd_rekey_ktls(int sock, unsigned read,
...
extern unsigned char tlshd_get_crypto_cipher(int sock, unsigned read);
